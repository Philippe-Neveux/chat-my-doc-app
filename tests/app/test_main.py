...
from app.main import app, validate_port, validate_host
...
class TestTyperCLI:
    ...
    def test_cli_short_options(self):
        ...
        with patch('app.main.create_chat_interface') as mock_create_interface:
            mock_interface = Mock()
            mock_create_interface.return_value = mock_interface
            mock_interface.launch = Mock()
...
class TestGradioInterface:
    ...
    @patch('app.main.get_available_models')  # Patch it where it's imported in main.py
